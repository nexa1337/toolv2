...
import { ArrowLeft, Upload, RotateCw, Loader2, Download, File as FileIcon } from "lucide-react";
    ...
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-zinc-50/50 dark:bg-zinc-950/50">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400 mt-1">Rotate your PDFs the way you need them.</p>
        </div>
            ...
            <CardContent>
              <div 
                ...
                className={`border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center cursor-pointer transition-colors ${
                  isDragActive ? 'border-rose-500 bg-rose-50/50 dark:bg-rose-900/20' : 'border-zinc-300 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-900/50'
                }`}
              >
                <input {...getInputProps()} />
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <label className="text-sm font-medium">Rotation Direction</label>
                ...
                <Button onClick={rotatePdf} disabled={isProcessing} className="w-full">
                  {isProcessing ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" /> Rotating...</> : <><RotateCw className="w-4 h-4 mr-2" /> Rotate PDF</>}
                </Button>
              </CardContent>
            </Card>
              ...
              <CardContent>
                {resultUrl ? (
                  <div className="h-full min-h-[200px] flex flex-col items-center justify-center space-y-4">
                    ...
                    <p className="font-medium text-center">PDF rotated successfully!</p>
                  ...
                  <div className="h-full min-h-[200px] flex flex-col items-center justify-center text-zinc-500">
                    <RotateCw className="w-12 h-12 mb-2 opacity-20" />
                    <p>Rotated file will appear here</p>
                  </div>
                )}
              </CardContent>
            </Card>
