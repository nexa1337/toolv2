...
export function Base64Tool() {
  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8 md:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">Base64 Encode/Decode</h1>
        ...
        <div className="flex items-center gap-4">
          <div className="flex rounded-lg bg-zinc-100 p-1 dark:bg-zinc-800">
            <button
              ...
              className={`rounded-md px-4 py-2 text-sm font-medium transition-colors ${mode === 'encode' ? 'bg-white text-zinc-900 shadow-sm dark:bg-zinc-900 dark:text-zinc-50' : 'text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50'}`}
            >
              Encode
            </button>
            <button
              onClick={() => { setMode('decode'); setOutput(''); setError(''); }}
              className={`rounded-md px-4 py-2 text-sm font-medium transition-colors ${mode === 'decode' ? 'bg-white text-zinc-900 shadow-sm dark:bg-zinc-900 dark:text-zinc-50' : 'text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50'}`}
            >
              Decode
            </button>
          </div>
