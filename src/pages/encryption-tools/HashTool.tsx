...
export function HashTool({ algorithm, title, description }: HashToolProps) {
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium text-zinc-900 dark:text-zinc-50">Hash Output</label>
              <button
                onClick={handleCopy}
                disabled={!output}
